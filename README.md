...
spec:
  interval: 1h
  url: https://github.com/dawg-io/zwave-js-ui-kustomize
  ref:
    tag: "REPLACE_WITH_LATEST_TAG"   # <-- check https://github.com/dawg-io/zwave-js-ui-kustomize/tags
```
...
```bash
git clone https://github.com/dawg-io/zwave-js-ui-kustomize.git
